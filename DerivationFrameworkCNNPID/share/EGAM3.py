...
from DerivationFrameworkCNNPID.DerivationFrameworkCNNPIDFactories import DerivationFramework__PhotonID

EGAM3_PhotonID = DerivationFramework__PhotonID("EGAM3_PhotonID", 
						SGKey_photons = "Photons",
						SGKey_caloCells = "AODCellContainer",
						N_eta = 7,
						N_phi = 11,
						CNN_model_name="DerivationFrameworkCNNPID/MixtureNN_CNN_CNNn_256_DNNn_128_lr_0.0001_dr_0.08_bt_32.onnx")

ToolSvc += EGAM3_PhotonID
...
augmentationTools = [EGAM3_EEMassTool,EGAM3_EEMassTool2,EGAM3_EEMassTool3,EGAM3_GainDecoratorTool,EGAM3_MaxCellDecoratorTool, EGAM3_PhotonID]
if DoCellReweighting:
